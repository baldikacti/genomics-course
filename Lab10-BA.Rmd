---
title: "Lab10 - Population genomics based on high throughput sequencing (HTS)"
...
opts_chunk$set(message = FALSE, error = FALSE, warning = FALSE,
               cache = FALSE, fig.width = 8, fig.height = 8)
...
```{r}
x <- vcfR2genlight(vcf) # Convert to genlight object
```
